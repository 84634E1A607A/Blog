...
之后电机系学生节来找我们借弹幕机用. 我们找了一圈我们的弹幕机怎么用的. 发现我们有前后两版弹幕机, 一版 `comments9`, 一版 `comment9`.  然后我们用的是 Comment9, 于是我关掉了 Comments9 虚拟机.
...
如果要说在这两年里我有多少收获, 那么必然是很多的. 我学会了一整套 Linux 的网络栈 (好吧没完全学会... 只会一点), 学习了如何使用 Docker (也没学会), 如何检查一台 Linux 机器里面有多少活服务, 谁曾经登录过机器, 如何管理 Linux 的权限 (用户和组), 怎么用 ESXi / vCSA, 怎么正确配置磁盘阵列, zfs, mdadm, 软 RAID, 硬 RAID, bla bla bla. 当然我也尝试了不少新鲜的东西, 包括但不限于写蜜罐, 部署 Gitlab, 部署 Gitea, 部署 Dify, 配置 Grafana 等等.
...
第二件, 关于到底为什么下一届有两个人竞选, 和导员的立场与态度, 我从一开始就从不同渠道听到了几种不同解释, 相互对不上, 前后对不上, 怎么都对不上. 我一向是相信面对面聊天直接传达的内容的. 但是在过去的两周我和不同主体聊到此事时, 他们都坚持自己的观点与看法, 这让我不得不怀疑这次选举的真实目的, 和是否我将成为一枚筹码, 抑或日后运维的工具.

如果果真这样, *我* 应该如何处理?

现在看科协的服务, 总觉得后背发凉, 感觉随时会爆几颗雷来个大的. 运维搞了两年, 现在的我已然不是那个誓要和一切💩山斗争到底的我了, 我更担心自己的清白, 我越来越对我不能 100% 了解和掌控的服务感到敬畏. 这实际上为我免去了很多麻烦.

(插个嘴, 这两天有个 800 块给会议室预约系统做二次开发的活, 我表明了我的态度是 "实在没人接我可以接, 但是我先评估系统, 如果不对劲我当场跑路". 后来一个我认识的同学接了, 发现她得先把 debian jessie + php5 的环境配明白. 她一不做二不休直接升级 php8. 换我就直接跑路了)

最近一直为这件事心情玉玉. 主要是, 我的理智告诉我我应该速速跑路, 但是毕竟两年心血在上面呢...

但是越想越觉得, *还是跑得越快越好吧*, 尽早逃离这是非之地...

## 终局

5 月 24 日, 学代会在新系馆 13 楼召开. 我半路跑进去见证了下一届科协主席的诞生. 结局与我的预期是一致的.

参加学代会的都是从各个班抓的壮丁, 它们并不熟悉科协的管理, 也不熟悉两位候选人, 也 *不关心* 科协未来的方向. 对大多数人而言, 科协如何与他们无关; 同时, 二人的经历差距是如此悬殊 --- 一位在科协的大地上默默耕耘, 为了科协 (和辅修统计学) 把自己的 GPA 整到了年级倒数, 经历也不过 "智能体部干事", "智能体部副主席" 寥寥几笔; 另一位在科创的前线, GPA 高高在上, 本科一作发表论文, 参加学校的各种计划, 到了大四, 前路一定, 便以科协主席之位点缀自己 (并无责备意). 竞选海报上一个空空荡荡, 一个熙熙攘攘. 正巧了, 投票的又不是接触过智能体的同学.

我也一样啊. 去年申请奖学金的时候, 一时间不知道往上面填什么好, 似乎一年半的运维工作并没有任何能落笔纸面的成绩, 只是 "关键服务稳定运行" 罢了.

结果是毫无悬念的. 也没有什么平票之类的戏码. 15:61, xry 成为下一届科协主席.

**至此, 我们的故事结束了. 而从今以后...... 就是「你」的故事啦~**
