...
description: 本文介绍了如何在 Windows 系统上使用 GoAuthing 实现校园网自动登录与掉线后自动重连，详细阐述了下载配置、脚本编写及任务计划设置的全过程，并明确指出当前方案因批处理脚本局限性导致无法区分登录错误与掉线状态，若修改密码或物理断网会导致脚本持续重试，而 Windows 原生脚本语言限制使得优化困难，需进一步改进 GoAuthing 以解决该问题。
tags:
  - 网络
  - 技术
---
