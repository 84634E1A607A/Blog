...
% \noindent
% \begin{tabular}{p{0.17\textwidth}p{0.83\textwidth}}
%     2025.2 - 2025.6 & \textbf{星链骨干网结构探测}
%         \fontsize{8pt}{10pt}\selectfont \begin{itemize}[left=0pt,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
%             \item 综合利用多种探测手段, 充分利用 Traceroute 特性, 编写专用工具加速探测;
%             \item 可得到全部骨干网 IP 的精确位置, 星链 PoP 之间的互联关系.
%         \end{itemize} \\
%     2025.3 - 2025.4 & \textbf{星链 IPv6 分配策略研究}
%         \fontsize{8pt}{10pt}\selectfont \begin{itemize}[left=0pt,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
%             \item 发现其分配策略按照地域划分, 同地域类似 ISP 分配策略;
%             \item 可以判断星链当前活跃用户数, 近期活跃用户数, 粗略估计终端比例.
%         \end{itemize} \\
%     2025.5 - 2025.6 & \textbf{星链终端固件研究}
%         \fontsize{8pt}{10pt}\selectfont \begin{itemize}[left=0pt,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
%             \item 逆向分析星链终端固件, 尝试摸清入网流程.
%         \end{itemize} \\
%     2025.8 - 2025.9 & \textbf{Catching the Spectrum Misuse of Direct-to-Cell Satellites at Scale}
%         \fontsize{8pt}{10pt}\selectfont \begin{itemize}[left=0pt,topsep=0pt,partopsep=0pt,parsep=0pt,itemsep=0pt]
%             \item 可以通过 LTE TA 信息和 TLE 推算连接的卫星;
%             \item 已投稿至 MobiCom'26.
%         \end{itemize}
% \end{tabular}
